...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"The computer choose an integer number between {MIN_VALUE} and {MAX_VALUE} and it's {magicNumber}"); 
        ...
        do
        {
            ...
            if (isParseSuccessful)
            {
                ...
                {
                    Console.Write($"Congratulations ! You found the Magic Number {magicNumber} in {attempt} attempt");
                    if (attempt > 1)
                    {
                        Console.Write("s");
                    }
